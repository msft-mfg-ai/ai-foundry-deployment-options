...
def create_book_index(endpoint: str, index_name: str) -> None:
    ...
    fields = [
        ...
        SearchableField(
            name="goodreads_book_id", type=SearchFieldDataType.String, filterable=True
        ),
        ...
        SimpleField(
            name="books_count", type=SearchFieldDataType.Int32, filterable=True
        ),
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Create Azure AI Search index using managed identity"
    )
    parser.add_argument("endpoint", help="Azure Search endpoint URL")
    parser.add_argument(
        "--index", default="good-books", help="Index name (default: good-books)"
    )
    parser.add_argument(
        "--books-url",
