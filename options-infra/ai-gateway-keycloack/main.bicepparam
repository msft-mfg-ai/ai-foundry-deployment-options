...
param keycloakClientSecret = readEnvironmentVariable('KEYCLOAK_CLIENT_SECRET')

var apimPublicNetworkAccessValue = toLower(readEnvironmentVariable('APIM_PUBLIC_NETWORK_ACCESS', 'false'))
param apimPublicNetworkAccess = apimPublicNetworkAccessValue == 'true'
