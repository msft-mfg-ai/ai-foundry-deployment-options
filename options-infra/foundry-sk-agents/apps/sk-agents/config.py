...
class Settings:
    ...
    FILE_PROCESSOR_URL: str = os.environ.get(
        "FILE_PROCESSOR_URL", "http://localhost:3001"
    )
    FILE_PROCESSOR_TIMEOUT: float = float(
        os.environ.get("FILE_PROCESSOR_TIMEOUT", "300")
    )
